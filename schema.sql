...
CREATE OR REPLACE FUNCTION "public"."count_transactions"("search_term" "text", "p_status" "public"."transaction_status" DEFAULT NULL::"public"."transaction_status", "p_type" "public"."transaction_type" DEFAULT NULL::"public"."transaction_type", "p_event_id" "uuid" DEFAULT NULL::"uuid", "p_start_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_end_date" timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS bigint
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN (
    ...
    WHERE
      (p_status IS NULL OR t.status = p_status) AND
      (p_type IS NULL OR t.type = p_type) AND -- << THÊM MỚI
      (p_event_id IS NULL OR t.event_id = p_event_id) AND
      (p_start_date IS NULL OR t.created_at >= p_start_date) AND
      (p_end_date IS NULL OR t.created_at <= p_end_date) AND
      (
...
ALTER FUNCTION "public"."count_transactions"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_transaction_stats"("search_term" "text", "p_status" "public"."transaction_status" DEFAULT NULL::"public"."transaction_status", "p_type" "public"."transaction_type" DEFAULT NULL::"public"."transaction_type", "p_event_id" "uuid" DEFAULT NULL::"uuid", "p_start_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_end_date" timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS SETOF "public"."transaction_stats"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_transaction_stats"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."handle_audit_columns"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."handle_audit_columns"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."search_transactions"("search_term" "text", "p_status" "public"."transaction_status" DEFAULT NULL::"public"."transaction_status", "p_type" "public"."transaction_type" DEFAULT NULL::"public"."transaction_type", "p_event_id" "uuid" DEFAULT NULL::"uuid", "p_start_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_end_date" timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS SETOF "public"."transactions"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."search_transactions"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "on_articles_audit" BEFORE INSERT OR UPDATE ON "public"."articles" FOR EACH ROW EXECUTE FUNCTION "public"."handle_audit_columns"();



CREATE OR REPLACE TRIGGER "on_bank_configs_audit" BEFORE INSERT OR UPDATE ON "public"."bank_configs" FOR EACH ROW EXECUTE FUNCTION "public"."handle_audit_columns"();



CREATE OR REPLACE TRIGGER "on_company_info_audit" BEFORE INSERT OR UPDATE ON "public"."company_info" FOR EACH ROW EXECUTE FUNCTION "public"."handle_audit_columns"();



CREATE OR REPLACE TRIGGER "on_email_configs_audit" BEFORE INSERT OR UPDATE ON "public"."email_configs" FOR EACH ROW EXECUTE FUNCTION "public"."handle_audit_columns"();



CREATE OR REPLACE TRIGGER "on_email_templates_audit" BEFORE INSERT OR UPDATE ON "public"."email_templates" FOR EACH ROW EXECUTE FUNCTION "public"."handle_audit_columns"();



CREATE OR REPLACE TRIGGER "on_events_audit" BEFORE INSERT OR UPDATE ON "public"."events" FOR EACH ROW EXECUTE FUNCTION "public"."handle_audit_columns"();



CREATE OR REPLACE TRIGGER "on_ticket_types_audit" BEFORE INSERT OR UPDATE ON "public"."ticket_types" FOR EACH ROW EXECUTE FUNCTION "public"."handle_audit_columns"();
...
CREATE OR REPLACE TRIGGER "on_vouchers_audit" BEFORE INSERT OR UPDATE ON "public"."vouchers" FOR EACH ROW EXECUTE FUNCTION "public"."handle_audit_columns"();
...
ALTER TABLE ONLY "public"."articles"
    ADD CONSTRAINT "articles_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."bank_configs"
    ADD CONSTRAINT "bank_configs_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."bank_configs"
    ADD CONSTRAINT "bank_configs_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."company_info"
    ADD CONSTRAINT "company_info_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."company_info"
    ADD CONSTRAINT "company_info_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."email_configs"
    ADD CONSTRAINT "email_configs_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."email_configs"
    ADD CONSTRAINT "email_configs_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id");
...
ALTER TABLE ONLY "public"."ticket_types"
    ADD CONSTRAINT "ticket_types_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id");
...
ALTER TABLE ONLY "public"."ticket_types"
    ADD CONSTRAINT "ticket_types_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id");
...
GRANT ALL ON FUNCTION "public"."count_transactions"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."count_transactions"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."count_transactions"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_transaction_stats"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."get_transaction_stats"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_transaction_stats"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."handle_audit_columns"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_audit_columns"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_audit_columns"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."search_transactions"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."search_transactions"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_transactions"("search_term" "text", "p_status" "public"."transaction_status", "p_type" "public"."transaction_type", "p_event_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "service_role";
